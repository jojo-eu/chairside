            ...
            <div className="space-y-4 justify-between">
              ...
              <p className="text-sm text-muted-foreground">
                {translate("crm.profile.inbound.description", {
                  _: "You can start sending emails to your server's inbound email address, e.g. by adding it to the Cc: field. Chairside will process the emails and add notes to the corresponding contacts.",
                  field: "Cc:",
                })}
              </p>
