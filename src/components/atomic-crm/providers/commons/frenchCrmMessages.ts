...
export const frenchCrmMessages = {
  ...
  crm: {
    ...
    auth: {
      ...
      welcome_title: "Bienvenue sur Chairside",
    },
    common: {
      activity: "Activité",
      added: "ajoutée",
    ...
    profile: {
      inbound: {
        description:
          "Vous pouvez commencer à envoyer des e-mails vers l'adresse de réception de votre serveur, par exemple en l'ajoutant au champ %{field}. Chairside traitera les e-mails et ajoutera des notes aux contacts correspondants.",
